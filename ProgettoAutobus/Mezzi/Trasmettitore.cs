...
namespace ProgettoAutobus
{
    static class Trasmettitore // l'elemento che trasmette i dati al server
    {
        ...
        static private int limiteRecord = 20; // indica quanti record vengono messi nella pila prima di creare un file nuovo con essa
        ...
        static void InoltraAlServer(JsonDataRecord jsonData)
        {
            ...
            if (!Spedisci("{ \"VettoreDati\": [ " + jsonData.ToString() + " ]}")) pila.Push(jsonData);
